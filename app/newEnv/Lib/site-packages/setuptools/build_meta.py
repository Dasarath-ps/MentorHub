...
def no_install_setup_requires():
    ...
    Under PEP 517, the app reports build dependencies to the frontend,
    and the frontend is responsible for ensuring they're installed.
    So setuptools (acting as a app) should not try to install them.
    """
...
class _BuildMetaLegacyBackend(_BuildMetaBackend):
    """Compatibility app for setuptools
