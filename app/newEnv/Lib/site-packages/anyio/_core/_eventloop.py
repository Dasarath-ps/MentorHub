...
def run(
    ...
    *args: Unpack[PosArgsT],
    ...
    :param backend_options: keyword arguments to call the app ``run()``
        implementation with (documented :ref:`here <app options>`)
    :return: the return value of the coroutine function
    :raises RuntimeError: if an asynchronous event loop is already running in this
        thread
    :raises LookupError: if the named app is not found
    ...
    try:
        ...
        raise LookupError(f"No such app: {backend}") from exc
...
def get_available_backends() -> tuple[str, ...]:
    ...
    :return a tuple of the built-in app names that were successfully imported
